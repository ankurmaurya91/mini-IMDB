...
var displaySearchlist=document.getElementsByClassName('search-item');
...
// Now here make function to search movies   
...
async function singleMovie(){
    // finding the id of movie from the url
...
async function displayMovieList(movies)
{
    ...
    //  console.log(output);
    document.querySelector('.search-item').innerHTML = output;
